      ...
      <div className="bg-white border-2 border-red-600 rounded-3xl shadow-2xl shadow-red-900/50 p-10 relative overflow-hidden">
        ...
        >
          ...
          >
            ...
            <span className="ml-2 text-sm font-semibold text-gray-900 group-hover:text-red-500 transition-colors">Google</span>
          </motion.button>
          ...
          >
            ...
            <span className="ml-2 text-sm font-semibold text-gray-900 group-hover:text-red-500 transition-colors">GitHub</span>
          </motion.button>
        </motion.div>
